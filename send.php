...
$mail->Port     = 587;
// Sender info 
$mail->setFrom('info@globallogisticpackers.com', 'Dtdc Cargo Movers'); 
$mail->addReplyTo('info@globallogisticpackers.com', 'Test Email'); 
...
if(!$mail->send()){ ?>
    ...
    window.location.href="https://globallogisticpackers.com/thanks.html";
    </script>
    // 
    <?php
